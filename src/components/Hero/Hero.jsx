...
export const Hero = () => {
  ...
  return (
    <div className="container m-auto mt-3 sm:mt-5 xl:mt-7">
              ...
              <div key={data.id}>
                <div className="    grid grid-cols-1 sm:grid-cols-2">
                  ...
                  <div className=" flex flex-col justify-center gap-4 px-5 py-5 sm:px-10 text-center sm:text-left relative ">
                    <h1 className="text-2xl sm:text-6xl font-bold lg:text-2xl">{data.subtitle}</h1>
                    <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold">{data.title}</h1>
                    <h1 className="text-5xl uppercase text-white dark:text-white/20 sm:text-[80px] lg:text-[100px] lg:text-[150] font-bold">{data.title2}</h1>
                    <div>
                      <Button text="Shop by Catagory" bgColor="bg-primary" textColor="text-white" />
                    </div>
                  </div>
                  {/* img section  */}
                  <div>
